    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Public car browsing
                        .requestMatchers(HttpMethod.GET, "/cars", "/cars/", "/cars/{id}",
                                "/cars/filters", "/cars/options").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/cars", "/cars/").hasAnyRole("MANAGER", "ADMINISTRATOR")
                        .requestMatchers(HttpMethod.PUT, "/cars/**").hasAnyRole("MANAGER", "ADMINISTRATOR")
                        .requestMatchers(HttpMethod.DELETE, "/cars/**").hasAnyRole("MANAGER", "ADMINISTRATOR")
